 ...
 *
 * VSYNC_FREQ,  /// Pin PA2(D5) is toggled at each VSYNC
 * RENDER_TIME, /// Pin PA6(D6) is high when frame rendering begins, low when finished
 * FRAME_RATE,  /// Pin PA1(D3) is toggled when the frame buffers are swapped.
 * MCU_ACTIVE   /// Pin PG12(D4) is high when framework is utilizing the MCU.
 *
