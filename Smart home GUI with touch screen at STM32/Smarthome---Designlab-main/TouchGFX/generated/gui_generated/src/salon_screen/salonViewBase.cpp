...
salonViewBase::salonViewBase() :
    buttonCallback(this, &salonViewBase::buttonCallbackHandler)
{
    ...
    textCounter.setTypedText(touchgfx::TypedText(T___SINGLEUSE_OUNR));
...
void salonViewBase::setupScreen()
{

}

void salonViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &lamp)
    {
        //oswietlenie
        //When lamp clicked call virtual function
        //Call oswietlenieSalonButtonClicked
        oswietlenieSalonButtonClicked();
    }
    else if (&src == &goBack)
    {
        //GoBack
    ...
    else if (&src == &floorHeating)
    {
        ...
        //Call podgrzewanieSalonButtonClicked
        podgrzewanieSalonButtonClicked();
    }
    else if (&src == &down)
    {
        //tempDown
